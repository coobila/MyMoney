...
public class DayInOutShow extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dayinoutshow);
        this.AccountName = "";
        try {
        ...
        this.ShowTop30.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: mymoney.zero.DayInOutShow.1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                DayInOutShow.this.ShowData("", "", "");
            }
        });
        this.MenuClick.setOnClickListener(new View.OnClickListener() { // from class: mymoney.zero.DayInOutShow.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                DayInOutShow.this.ShowMenu();
            }
        });
...
//            String tSDCardPath = Environment.getExternalStorageDirectory().getAbsolutePath();
        ...
        this.cursor.close();
        this.DataList.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: mymoney.zero.DayInOutShow.3
            @Override // android.widget.AdapterView.OnItemClickListener
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                DayInOutShow.this.MakeNoSpinner.setSelection(position);
                DayInOutShow.this.MakeNoRec.setText(DayInOutShow.this.MakeNoSpinner.getSelectedItem().toString().trim());
                view.showContextMenu();
            }
        });
        this.DataList.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() { // from class: mymoney.zero.DayInOutShow.4
        ...
        this.DataDB.close();
        SimpleAdapter listItemAdapter = new SimpleAdapter(this, listItem, R.layout.dayinoutlistitem, new String[]{"DataDate", "Week", "SourceItem", "DataYear", "ShowClass", "ObjectItem", "OutMount", "InMount", "TrnMount", "PMount", "DataNote", "ItemImage", "CollNameImage", "InvoiceImage", "DetailImage"}, new int[]{R.id.DataDate, R.id.Week, R.id.SourceItem, R.id.DataYear, R.id.ShowClass, R.id.ObjectItem, R.id.OutMount, R.id.InMount, R.id.TrnMount, R.id.PMount, R.id.DataNote, R.id.ItemImage, R.id.CollNameImage, R.id.InvoiceImage, R.id.DetailImage});
    ...
    public void ShowBox(String TitleString, String BodyString) {
        ...
        DialogInterface.OnClickListener OkClick = new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.5
...
//            startActivity(intent);
    ...
    public void NoteFind() {
        ...
        alert.setView(input);
        input.setText("");
        DialogInterface.OnClickListener OkClick = new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.6
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
                String InputNote = input.getText().toString();
                DayInOutShow.this.ShowData(InputNote, "", "");
            }
        };
        DialogInterface.OnClickListener CanCelClick = new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.7
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
            }
        };
    ...
    public void Note1Find() {
        ...
        alert.setView(input);
        input.setText("");
        DialogInterface.OnClickListener OkClick = new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.8
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
                String InputNote = input.getText().toString();
                DayInOutShow.this.ShowData("", InputNote, "");
        ...
        DialogInterface.OnClickListener CanCelClick = new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.9
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
            }
        };
    ...
    public void Note2Find() {
        ...
        alert.setView(input);
        input.setText("");
        DialogInterface.OnClickListener OkClick = new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.10
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
                String InputNote = input.getText().toString();
                DayInOutShow.this.ShowData("", "", InputNote);
        ...
        DialogInterface.OnClickListener CanCelClick = new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.11
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
            }
        };
...
//            String tSDCardPath = Environment.getExternalStorageDirectory().getAbsolutePath();
        ...
        alert.setPositiveButton("確定刪除", new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.12
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int whichButton) throws SQLException {
                DayInOutShow.this.KillData();
            }
        });
        alert.setNegativeButton("取消", new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.13
            @Override // android.content.DialogInterface.OnClickListener
...
//                    String tSDCardPath = Environment.getExternalStorageDirectory().getAbsolutePath();
                    String tSDCardPath = String.valueOf(getExternalFilesDir(null));
                    try {
                        DayInOutShow.this.DataDB = SQLiteDatabase.openDatabase(String.valueOf(tSDCardPath) + "/MyMoneyZero/mymoney.db", null, 0);
                    } catch (Exception e) {
                    }
                    DayInOutShow.this.SQL = "UPDATE SYSTEM_DATA SET DATA_VALUE = '1' WHERE USER_ID = 'admin' AND ACCOUNT_ID = " + String.valueOf(DayInOutShow.this.AccountId) + " AND DATA_NOTE = '帳務記錄顯示發票號碼'";
                    DayInOutShow.this.DataDB.execSQL(DayInOutShow.this.SQL);
                    Intent intent1 = new Intent();
                    intent1.setClass(DayInOutShow.this, DayInOutShow2.class);
                    DayInOutShow.this.startActivity(intent1);
                    DayInOutShow.this.finish();
                }
            }
        };
        DialogInterface.OnClickListener OkClick = new DialogInterface.OnClickListener() { // from class: mymoney.zero.DayInOutShow.15
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
            }
        };
